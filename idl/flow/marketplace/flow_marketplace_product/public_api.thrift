...
struct GetProductListRequest {
    ...
    8  : optional list<i64>                         PublishPlatformIDs (agw.js_conv="str", api.js_conv="true",  agw.cli_conv="str", agw.source = "query", agw.key = "publish_platform_ids"), // distribution channel
...
struct BotExtraInfo {
    1:          list<BotPublishPlatform>          PublishPlatforms      (agw.key = "publish_platforms", api.body= "publish_platforms")                                              , // distribution channel
    2:          i32                               UserCount             (agw.key = "user_count", api.body= "user_count")                                                     , // user
...
struct SocialSceneExtraInfo {
    ...
    4: product_common.ProductPublishMode PublishMode (agw.key = "publish_mode", api.body= "publish_mode") // open and closed source
}
...
struct ProjectExtraInfo {
     ...
     4: i32 UserCount (agw.key="user_count", api.body= "user_count"), // user
     5: i32 ExecuteCount (agw.key="execute_count", api.body= "execute_count"), // number of runs
     6: list<BotPublishPlatform> PublishPlatforms (agw.key = "publish_platforms", api.body= "publish_platforms"), // distribution channel
...
struct GetUserFavoriteListV2Request {
    ...
    5  : optional string                            Keyword    (api.query = "keyword")    , // non-empty search
