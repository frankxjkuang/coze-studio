...
struct UpdateDraftBotInfoAgwData {
    ...
    2:          bool   check_not_pass   // True: The machine verification failed
...
struct GetSpaceListV2Request {
    ...
    3: optional i64 organization_id (api.js_conv='true',agw.js_conv="str") // tissue id
...
struct BotSpaceV2 {
    ...
    15: optional i64    organization_id (api.js_conv='true',agw.js_conv="str") // tissue id
